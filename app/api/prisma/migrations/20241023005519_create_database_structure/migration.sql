...
-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIM', 'MEMBER', 'BILLING');
...
CREATE TABLE "accounts" (
    ...
    "provier_account_id" TEXT NOT NULL,
    "user_id" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "accounts_provier_account_id_key" ON "accounts"("provier_account_id");
